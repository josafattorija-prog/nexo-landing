      ...
      <div className="shell">
        ...
        <div className="mod-grid">
          ...
          <Reveal className="mod span6">
            ...
            <p>Inventario ilimitado, fotos en alta, tours 360, ficha PDF auto-generada y publicación con un click en tu sitio web premium.</p>
            <div style={{ display: "flex", gap: 8, marginTop: 18, flexWrap: "wrap" }}>
              {["Fotos HD", "Tours 360", "Ficha PDF", "Sitio web"].map((p) => (
